...
public class SimpleWebServer extends NanoHTTPD {
    ...
    public static void main(String[] args) {
        ...
        for (WebServerPluginInfo info : serviceLoader) {
            ...
            for (String mime : mimeTypes) {
                ...
                if (!quiet) {
                	MyLog.i("# Found plugin for Mime type: \"" + mime + "\"");
                    System.out.print("# Found plugin for Mime type: \"" + mime + "\"");
                    if (indexFiles != null) {
                        MyLog.i(" (serving index files: ");
    ...
    public Response serve(IHTTPSession session) {
        ...
        if (!quiet) {
            ...
            MyLog.i("SimpleWebServer::serve "+session.getMethod() + " '" + uri + "' ");

            Iterator<String> e = header.keySet().iterator();
            while (e.hasNext()) {
                String value = e.next();
                System.out.println("  HDR: '" + value + "' = '" + header.get(value) + "'");
                MyLog.i("  HDR: '" + value + "' = '" + header.get(value) + "'");
            }
            e = parms.keySet().iterator();
            while (e.hasNext()) {
                String value = e.next();
                System.out.println("  PRM: '" + value + "' = '" + parms.get(value) + "'");
                MyLog.i("  PRM: '" + value + "' = '" + parms.get(value) + "'");
            }
        }
