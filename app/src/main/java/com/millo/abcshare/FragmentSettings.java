 ...
 * {@link FragmentSettings.OnFragmentSettingsInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragmentSettings#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentSettings extends Fragment {
    public static final String TAG = "ABCShare FragmentSettings";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btBack = (Button) v.findViewById(R.id.btBack);
...
//    }
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mListener = (OnFragmentSettingsInteractionListener) activity;
